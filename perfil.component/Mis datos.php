...
<div class="border-left mt-4 px-4">
  ...
  <form class="" action="" method="post">
    <div class="form-group">
      ...
      <input class="form-control border-br mb-2" type="text" name="username" value="<?=$nombreUsuario?>" placeholder="Usuario">
      <button class="btn btn-secondary btn-block" type="button" name="changePassword">Cambiar contraseña</button>
    </div>
    <div class="form-group">
      <h2>Datos personales</h2>
      <input class="form-control border-br mb-2" type="text" name="name" value="<?=$nombrePropio?>" placeholder="Nombre">
      <input class="form-control border-br mb-2" type="text" name="lastname" value="<?=$apellido?>" placeholder="Apellido">
