    ...
    <div class="container mt-2 pt-4 mb-2">
      ...
      <form action="registro.php" class="row pt-4" method="post">
        ...
        <div class="form-group col-12">
          <textarea class="form-control bg-dark text-white" name="name" rows="8"  placeholder="Mensaje"></textarea>
        </div>

        <div class="col-12 mt-4 d-flex justify-content-end">
          <button type="submit" class="btn btn-primary col-4" name="enviar" value="Enviar">Enviar consulta</button>
        </div>
