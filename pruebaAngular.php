<?php
  ...
  $tabContent = [
    ["id" => "resumen", "aria-labelledby" => "resumen-tab", "pagina" => "categorias.php"],
    ...
    ["id" => "misDatos", "aria-labelledby" => "misDatos-tab", "pagina" => "categorias.php"],
...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="perfil.component/perfil.component.css">
          ...
          <nav class="navbar sticky-top navbar-light bg-celeste d-flex flex-column align-items-center icon-size rounded-right shadow-sm">
            ...
            <div class="collapse show" id="navbarNavDropdown">
              <ul class="nav navbar-nav" role="tablist">
                <li class="nav-item">
                  <a class="nav-link active" id="resumen-tab" href="#Mis datos" data-toggle="tab" role="tab" aria-controls="resumen" aria-selected="true">
